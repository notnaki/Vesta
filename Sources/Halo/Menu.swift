...
/// menus, so Halo/Edit/View/Window/Help are constructed by hand. App-level items
...
func makeMainMenu(target: AppDelegate) -> NSMenu {
    ...
    help.addItem(withTitle: "Halo Help", action: #selector(AppDelegate.showHelp), keyEquivalent: "?")
        .target = target
    NSApp.helpMenu = help
